...
var _b1 = new Bridge({host: 'localhost', port: 8090, apiKey: 'abcdefgh'}).connect();
var _b2 = new Bridge({host: 'localhost', port: 8090, apiKey: 'abcdefgh'}).connect();
...
function initClient() {
    for (var i = 0; i < 10; i++) {
        var b = new Bridge({host: 'localhost', port: 8090, apiKey: 'abcdefgh'}).connect();
        (function (id) {
            b.ready(function() {
